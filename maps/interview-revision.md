...
1. Predict the shapes in the broadcasting and distance cells of the [NumPy refresher](../notebooks/01-foundations/01_numpy_interview_refresher.ipynb).
2. Rehearse `groupby().agg`, `transform`, `merge`, and time-safe `shift` in the [pandas refresher](../notebooks/01-foundations/02_pandas_interview_refresher.ipynb).
...
|---|---|---|
| 1 | shapes, axes, broadcasting | [NumPy](../notebooks/01-foundations/01_numpy_interview_refresher.ipynb) |
| 2 | groupby, joins, dates | [pandas](../notebooks/01-foundations/02_pandas_interview_refresher.ipynb) |
...
| 5 | preprocessing and model search | [sklearn](../notebooks/03-sklearn/01_tabular_pipelines.ipynb) |
